...
The protocol is ready when a Lead can classify a task, select a configured
route/topology, assign one writer, identify a stable candidate and proof gate,
handle all three escalation requests, and tell which remaining decision belongs
to the Human without guessing.
